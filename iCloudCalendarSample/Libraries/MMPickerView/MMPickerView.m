...
+(void)showDatePickerViewInView:(UIView *)view withOptions:(NSDictionary *)options completion:(void (^)(id))completion
{
    [[self sharedView] showDatePicker:options view:view];
...
-(void)showDatePicker:(NSDictionary*)options view:(UIView*)view
{
...
+(void)setMaxDateShow:(BOOL)value

{
    [self sharedView].isMaxDateShow=value;
